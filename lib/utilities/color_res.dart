...
class ColorRes {
  ...
  static const Color themeGradient1 = Color(0xFF2C2C2C);
  static const Color themeGradient2 = Color(0xFF1A1A1A);
  static const Color themeAccentSolid = Color(0xFF222222);
