...
class ColorRes {
  ...
  static const Color bgDeep         = Color(0xFF0D0E12);
  static const Color themeColor     = Color(0xFF15161A);
  static const Color themeGradient2 = Color(0xFF1C1D22);
  static const Color themeGradient1 = Color(0xFF242529);
  static const Color themeAccentSolid = Color(0xFF2E2F35);
  static const Color borderSubtle   = Color(0xFF2A2B30);
  static const Color borderMedium   = Color(0xFF3A3B42);
  ...
  static const Color orangeDim      = Color(0x33FF7A19);
